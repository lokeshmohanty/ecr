...
export function TopBar(props: { store: AppStore; onSync: () => void }) {
  return (
  ...
  return (
    <footer class="flex items-center gap-3 border-t border-border bg-bg-panel px-3 py-1 text-xs">
      <span
        ...
        classList={{
          "bg-accent text-bg-main": props.store.mode() === "normal",
          "bg-tag-unread text-bg-main": props.store.mode() === "insert",
          "bg-tag-default text-bg-main":
...
export function Help(props: { store: AppStore; bindings: { keys: string; description: string }[]; onClose: () => void }) {
  return (
    <div
    ...
    >
      ...
      >
        <h2 class="mb-3 uppercase tracking-widest text-text-dim">Keybindings</h2>
  ...
  return (
    <div class="flex h-full items-center justify-center p-6">
      ...
      >
        ...
        <button
          type="submit"
          class="touch-target w-full rounded bg-accent px-3 py-2 font-semibold text-bg-main"
        >
          Connect
        </button>
