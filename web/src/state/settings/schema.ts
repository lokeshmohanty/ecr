...
export interface Preferences {
	...
	timezone: string;
	/** Announce arriving mail through the system's notifications. */
...
export const PREFERENCE_DOCS: Record<keyof Preferences, PreferenceDoc> = {
	...
	theme: {
		...
		values:
			"themes/ecr-dark.toml | themes/tokyonight.toml | any file you write",
	},
	sidebarIcons: {
		section: "sidebar",
		scope: "client",
	...
	sidebarSections: {
		section: "sidebar",
		scope: "client",
		doc: "Which sections appear, and in what order. Drop one to hide it entirely;\ntags and lists are gathered from the database, so an empty list leaves\nonly the mailboxes.",
		values: "a list of: mailboxes, tags, lists",
	},
	sidebarCustom: {
		section: "sidebar",
		scope: "client",
