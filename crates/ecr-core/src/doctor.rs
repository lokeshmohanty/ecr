...
pub enum ConfigSource {
    /// Generated by ecr, because this package is set to `management = "ecr"`.
    /// It outranks every other candidate: a reader who asked ecr to own the
    /// file did not also ask for their old one to keep winning.
    Managed,
    ServerToml,
    EnvVar(String),
    Xdg,
...
impl fmt::Display for ConfigSource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ConfigSource::Managed => f.write_str("ecr-managed"),
